...
class BigParent extends ORMObject
{
    protected static function initializeRecord(ElementBuilder $builder)
    {
        ...
        $builder->referRecord(BigParent::class,'p_self_ref')->setAllowedProperty(BigParent::class);
        $builder->referRecord(Dummy::class,'p_mult_ref')->setAllowedProperty(ChildObject::class);
